...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"dist/notiflix-aio-3.2.4.min.js":[function(require,module,exports) {
var define;
...
(function (root, factory) {
  ...
  var blockCreateOrRemove = function (isCreate, blockType, selectorOrHTMLElements, messageOrOptions, options, delay) {
    ...
    var positionClassForNonStaticRef = 'nx-block-temporary-position'; // block
    ...
    if (isCreate) {
      ...
      for (var queryIndex = 0; queryIndex < checkQueryLimit; queryIndex++) {
        ...
        if (eachElement) {
          ...
          if (eachBlockElement.length < 1) {
            ...
            if (addPosition || minHeightStyle.length > 0) {
              ...
              window.document.head.appendChild(styleFragment); // add the "positionClassForNonStaticRef" to each element
        ...
        var removeEachElementClassName = function (eachElement) {
          var timeout = setTimeout(function () {
            // remove class name
            eachElement.classList.remove(positionClassForNonStaticRef); // clear timeout
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","dist/notiflix-aio-3.2.4.min.js"], null)
//# sourceMappingURL=/notiflix-aio-3.2.4.min.46a7821d.js.map